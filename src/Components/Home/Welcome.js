  ...
  return (
    <div className="relative">
      <div className="px-8 md:px-16 lg:px-24">
        <div className="pt-14 ">
          <div className="text-2xl md:text-4xl lg:text-5xl text-white font-black md:font-bold lg:font-black">
          ...
          <div className="my-6">
            <div className="w-[180px] h-[62px] rounded-full flex items-center justify-center ">

...
const Technology = () => {
  return (
    <div className="py-8 relative">
      <div className=" px-6 lg:px-24 flex items-center justify-center gap-x-2">
        <div className="flex items-center gap-x-2 text-white text-xl md:text-3xl lg:text-5xl font-bold">
      ...
      <div className=" px-6 lg:px-24 w-full flex items-center justify-center py-8 relative">
        ...
        <div className="w-full absolute top-0">
          <img
            src={Eclipse}
            alt="eclipse"
            className="h-[40rem] w-full object-fill mix-blend-overlay"
          />
        </div>
      </div>
      ...
      <div className="w-full flex items-center justify-center pt-12  px-6 lg:px-24">

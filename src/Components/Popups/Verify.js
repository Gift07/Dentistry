      ...
      <div className="w-11/12 md:w-8/12 lg:w-1/2 bg-[#2b275a] rounded-2xl p-2">
        <div className="flex items-center justify-center gap-x-6 my-4">
          <div>
            ...
            <p className="my-2 text-xs text-white font-lightpriego">
        ...
        <div className="flex items-center justify-center gap-x-6 my-4">
          ...
          <div>
            <div className="flex items-center justify-center text-lg gap-x-2">
              <h1 className="text-orange-500 font-semibold">1 Lakh </h1>
              <h1 className="font-semibold text-white">Patients</h1>
            </div>
            <p className="my-2 text-xs text-white font-lightpriego">
        ...
        <div className="flex items-center justify-center gap-x-6 my-4">
          <div>
            <div className="flex items-center justify-center text-lg gap-x-2">
              <h1 className="text-orange-500 font-semibold">60</h1>
              <h1 className="font-semibold text-white">Clinics</h1>
            </div>
            <p className="my-2 text-xs text-white font-lightpriego">
          ...
          <form>
            <div className="w-full flex items-center justify-center font-lightpriego gap-x-6">
              <div className="flex items-center justify-center py-3">
                <input
                  maxLength={1}
                  className="text-center p-2 w-12 h-12 text-gray-100 flex items-center justify-center rounded-full outline-none bg-[#2b275a] shadow-xl  drop-shadow-lg"
                />
              </div>
              <div className="flex items-center justify-center py-3">
                <input

  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="px-10 lg:px-96">
            ...
            <div className="h-[98px] lg:h-32 w-full lg:w-96 gap-x-3 flex items-center p-4  bg-[#02ffdd] rounded-full">
              <div className="h-[76px] lg:h-28 flex items-center justify-center bg-white rounded-full w-[76px]">
                <img
                  src={Figure2}
                  alt="figure"
                  className="h-[49px] lg:h-20 w-[39px] lg:w-20 rounded-full object-cover"
                />
              </div>
              <div>
        ...
        <div className="w-full flex items-center justify-end py-3">
          <div className="h-[98px] lg:h-32 w-full lg:w-96 gap-x-3 flex items-center p-4  bg-[#ea00ff] rounded-full">
            <div className="h-[76px] lg:h-28 flex items-center justify-center bg-white rounded-full w-[76px]">
              <img
                src={Figure1}
                alt="figure"

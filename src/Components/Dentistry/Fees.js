  ...
  return (
    <div className="w-screen bg-white">
      <div className="w-full flex items-center justify-center pt-8  md:pt-12 lg:pt-16">
        <div className="text-2xl md:text-3xl lg:text-5xl  font-bold w-full flex flex-col items-center justify-center text-[#313131]">
          <h1 className="text-[#c82bd6] flex items-center">
            ₹3000 <AiOutlineMinus /> ₹5000
          </h1>
